...
import CreateActionModal from '../FilterSection/ActionButton/CreateActionModal'
...
const TableSection = () => {
  ...
  return (
    <>
                ...
                meetings.map((meeting) => (
                  ...
                  >
                    ...
                    <Td borderRightWidth={1} fontWeight={500}>
                      {format(new Date(meeting.time as string), 'PP hh:mm b')}
                    </Td>
                    <Td borderRightWidth={1} fontWeight={500}>
                    ...
                    <Td fontWeight={500}>
                      <Button
                        bg="cyan.200"
                        size="sm"
                        onClick={() => setEditedMeeting(meeting)}
                      >
                        <Icon as={BiEditAlt} />
                      </Button>
                    </Td>
      ...
      {editedMeeting && (
        <CreateActionModal
          isOpen={Boolean(editedMeeting)}
          setIsOpen={() => setEditedMeeting(null)}
